...
dados_cursos_tratado_2011  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2011)
dados_cursos_tratado_2012  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2012)
dados_cursos_tratado_2013  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2013)
dados_cursos_tratado_2014  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2014)
dados_cursos_tratado_2015  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2015)
dados_cursos_tratado_2016  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2016)
dados_cursos_tratado_2017  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2017.csv') |> dplyr::mutate(ano = 2017)
dados_cursos_tratado_2018  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2018.csv') |> dplyr::mutate(ano = 2018)
dados_cursos_tratado_2019  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2019.csv') |> dplyr::mutate(ano = 2019)
dados_cursos_tratado_2020  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2020.csv') |> dplyr::mutate(ano = 2020)
dados_cursos_tratado_2021  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2021.csv') |> dplyr::mutate(ano = 2021)
dados_cursos_tratado_2022  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2022.csv') |> dplyr::mutate(ano = 2022)
dados_cursos_tratado_2023  <- read.csv2(file = 'informacao/informacao/dados/processado/dados_cursos_tratado_2023.csv') |> dplyr::mutate(ano = 2023)

## Dados de universidades de modo geral
dados_ies_tratado     <- read.csv2(file = 'informacao/informacao/dados/processado/dados_ies_tratado_2023.csv')
...
## Ingressantes
write.csv(ingress, file = "informacao/informacao/dados/processado/final_ingressantes.csv", row.names = FALSE)

## Cursos
write.csv(eng_civil, file = "informacao/informacao/dados/processado/final_eng_civil.csv", row.names = FALSE)
write.csv(direito, file = "informacao/informacao/dados/processado/final_direito.csv", row.names = FALSE)
write.csv(medicina, file = "informacao/informacao/dados/processado/final_medicina.csv", row.names = FALSE)
write.csv(administracao, file = "informacao/informacao/dados/processado/final_administracao.csv", row.names = FALSE)
